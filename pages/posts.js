...
import thumbTailwindEffect from '../public/images/contents/tailwind-effect.png'
    ...
    <Container>
      ...
      <Section delay={0.1}>
        <SimpleGrid columns={[1, 2, 2]} gap={6}>
          <GridItem
            title="The Tailwind Effect"
            thumbnail={thumbTailwindEffect}
            href="https://blog.brandonzane.com/the-tailwind-effect"
          />
          {/* <GridItem
